             ...
             <div class="modal-body">
                <div class="form-row">
                 ...
                 <div class="form-group col-md-4">
                    ...
                    <input type="number" name="total1" class="form-control <?php //echo (isset($error['Nombre']))?"is-invalid":""; ?>"  value="<?php echo $filaCaja['totalCaja']; ?>" required >
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" name="subtotal1"  class="form-control <?php //echo (isset($error['ApellidoP']))?"is-invalid":""; ?>" value="<?php echo $filaCaja['subtotalCaja']; ?>" required >
                    <div class="invalid-feedback">
       ...
       <form action="" method="post" enctype="multipart/form-data">              
             ...
             <div class="modal-body">
                 ...
                 <div class="form-group col-md-4">
                    <label for="">Total: </label>
                    <input type="number" name="total" class="form-control <?php //echo (isset($error['Nombre']))?"is-invalid":""; ?>" value=" " required >
                    <div class="invalid-feedback">
                        <?php //echo (isset($error['Nombre']))?$error['Nombre']:""; ?>
                    </div>
                    <br>
                    ...
                    <div class="form-group col-md-4">
                    <label for="">Subtotal: </label>
                    <input type="number" name="subtotal" class="form-control <?php //echo (isset($error['ApellidoP']))?"is-invalid":""; ?>" value=" " required >
                    <div class="invalid-feedback">
                        <?php //echo (isset($error['ApellidoP']))?$error['ApellidoP']:""; ?>
                    </div>
                    <br>
            ...
            <div class="row align-items-start" style="height: 618px">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tr class="table-info">
                        ...
                        <td><?php echo $datos['subtotalCaja']; ?></td>
                        <td><?php echo $datos['totalCaja']; ?> </td>
                        <td><?php echo $datos['fechaCaja']; ?> </td>
                        <td>
                            <form action="" method="post">
                                <input type="hidden" name="txtID1" value="<?php echo $datos['idCaja']; ?>">
