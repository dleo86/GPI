...
if($info == 1 && isset($_POST["btnBarra"])){
    
    $mensaje='';
    $sql = "SELECT userName, COUNT(*) FROM venta, usuario WHERE idUsuario = Usuario_idUsuario AND fechaVenta BETWEEN '$fecha1' AND '$fecha2' GROUP BY userName"; 
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
             ['Usuario', 'Cantidad de ventas. <?php echo "Desde $fechaInicial hasta $fechaFinal"; ?>' ], 
           ...
           var options = {
                title: 'Cantidad de ventas por usuario',
                colors: ['#101b87'],
                titleTextStyle: {
...
<?php } 
 else if($info == 1 && isset($_POST["btnCircular"])){
    $mensaje='';
    $sql = "SELECT userName, COUNT(*) FROM venta, usuario WHERE idUsuario = Usuario_idUsuario AND fechaVenta BETWEEN '$fecha1' AND '$fecha2' GROUP BY userName"; 
    $consulta = $conexion->conectar()->prepare($sql);
    $consulta ->execute();  
...
<head>
   ...
   <link rel="stylesheet" href="../../css/estilo_informes.css">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
           ...
           var options = {
                title: 'Cantidad de ventas de cada usuario ',
  ...
  chart.draw(data, {
    ...
    height: 600,
    width: 1400,
    title: 'Cantidad de ventas de cada usuario <?php echo "desde $fechaInicial hasta $fechaFinal"; ?>',
    titleTextStyle: {
                   color: 'black',    // any HTML string color ('red', '#cc00cc')
                   fontName: 'Times New Roman', // i.e. 'Times New Roman'
...
<?php } else if($info == 1 && isset($_POST["btnLineal"])){
    $mensaje='';
    $sql = "SELECT userName, COUNT(*) FROM venta, usuario WHERE idUsuario = Usuario_idUsuario AND fechaVenta BETWEEN '$fecha1' AND '$fecha2' GROUP BY userName"; 
    $consulta = $conexion->conectar()->prepare($sql);
    $consulta ->execute();  
