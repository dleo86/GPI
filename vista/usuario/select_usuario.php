          ...
          <div class="modal-body">
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="usuario1" class="form-control"  value="<?php echo $filaUsuario['userName']; ?>" placeholder="" required >
                    <div class="invalid-feedback">
                        <?php //echo (isset($error['ApellidoM']))?$error['ApellidoM']:""; ?>
                    </div>
                    <br>
                </div>
                  <?php if(strcmp($_SESSION['userName'], $filaUsuario['userName']) === 0){ ?>
                  <div class="form-group col-md-4">
                    <label for="">Contraseña: </label>
                    <input type="password" name="pass1" id="pass" class="form-control" value="<?php echo $_SESSION['userPass']; ?>" placeholder="" required >
                    <div class="invalid-feedback">
                        <?php //echo (isset($error['ApellidoM']))?$error['ApellidoM']:""; ?>
                    </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="priv1"  >
                        <option value="<?php echo $filaUsuario['userPriv'];?>" ><?php echo $filaUsuario['userPriv'];?></option>                      
                        <?php echo "<option> Usuario </option>"; ?>
                    </select> 
                    <div class="invalid-feedback">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="email" name="email1" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="<?php echo $filaUsuario['emailPersona']; ?>" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
                ...
                <div class="form-group col-md-4">
                    <label for="">DNI: </label>
                    <input type="number" name="dni1" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="<?php echo $filaUsuario['dniPersona']; ?>" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
			...
			<?php } ?>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="number" name="postal1" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="<?php echo $filaUsuario['codPostal']; ?>" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="loc1" >
                        <option value="<?php echo $filaUsuario['idLocalidad'];?>" ><?php echo $filaUsuario['nombreLoc'];?></option>
			...
			<?php endforeach; ?>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="iva1" >
                        <option value="<?php echo $filaUsuario['idIva'];?>" ><?php echo $filaUsuario['descripIva'];?></option>
   ...
   <form action="" method="post" enctype="multipart/form-data">     
          ...
          <div class="modal-body">
              <div class="form-row">
               ...
               <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    <label for="">Usuario: </label>
                    <input type="text" name="usuario" class="form-control" value=" " placeholder="" required >
                    <div class="invalid-feedback">
                        <?php //echo (isset($error['ApellidoM']))?$error['ApellidoM']:""; ?>
                    </div>
                    <br>
                  ...
                  <div class="form-group col-md-4">
                    <label for="">Contraseña: </label>
                    <input type="password" name="pass" id="pass" class="form-control" value="" placeholder="" required >
                    <div class="invalid-feedback">
                        <?php //echo (isset($error['ApellidoM']))?$error['ApellidoM']:""; ?>
                    </div>
                    <input name="pass"  type="checkbox" onclick="Mostrar()">    
                ...
                <div class="form-group col-md-8">
                    ...
                    <select class="form-control" name="priv">                                           
                        <?php echo "<option value=Usuario>Usuario </option>"; ?>
                    </select> 
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                ...
                <div class="form-group col-md-4">
                    <label for="">Email: </label>
                    <input type="email" name="email" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value=" " placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
                ...
                <div class="form-group col-md-4">
                    <label for="">DNI: </label>
                    <input type="number" name="dni" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value=" " placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
			...
			<?php } ?>
                ...
                <div class="form-group col-md-2">
                    <label for="">Cod Post: </label>
                    <input type="number" name="postal" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value=" " placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
        ...
        <div class="modal-footer">
                <button value="btnAgregar" name="btnAgregar" class="btn btn-success" type="submit" >Agregar</button>            
                <button type="button" value="Cancelar" data-dismiss="modal" aria-label="Close" name="btnCancelar" class="btn btn-primary"><span aria-hidden="true">Cancelar</span></button>                              
        </div>
        </div>
        </div>
            ...
            <div class="row align-items-start" style="height: 638px">
                ...
                <table class="table table-hover table-bordered">
                        ...
                        <form action="" method="post">
                               <button type="submit" class="btn btn-primary" name="accion2">
                                ...
                                <div class="col-xs-2" style="margin: 10px;">
                                    <input class="form-control mr-sm-2" type="text" name="buscarUser" placeholder="Buscar por usuario">
                                </div>
                    ...
                    <tr class="table-info">
                        ...
                        <td>
                            <form action="" method="post">
                                <input type="hidden" name="txtID1" value="<?php echo $datos['idUsuario']; ?>">
