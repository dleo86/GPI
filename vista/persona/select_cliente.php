        ...
        <div class="modal-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="date" name="nac1" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="<?php echo $filaCliente['nacPersona']; ?>" placeholder=""   >
                    <div class="invalid-feedback">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="tel1" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="<?php echo $filaCliente['telPersona']; ?>" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="email" name="email1" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="<?php echo $filaCliente['emailPersona']; ?>" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
			...
			<?php } ?>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="number" name="postal1" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="<?php echo $filaCliente['codPostal']; ?>" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="loc1" >
                        <option value="<?php echo $filaCliente['idLocalidad'];?>" ><?php echo $filaCliente['nombreLoc'];?></option>
			...
			<?php endforeach; ?>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="iva1" >
                        <option value="<?php echo $filaCliente['idIva'];?>" ><?php echo $filaCliente['descripIva'];?></option>
    ...
    <form action="" method="post" enctype="multipart/form-data">   
        ...
        <div class="modal-body">
            <div class="form-row">                 
                ...
                <div class="form-group col-md-4">
                    <label for="">DNI: </label>
                    <input type="text" name="dni" class="form-control" value=" " placeholder="" required >
                    <div class="invalid-feedback">
                        <?php //echo (isset($error['ApellidoM']))?$error['ApellidoM']:""; ?>
                    </div>
                    <br>
        ...
        <div class="modal-footer">
                ...
                <table class="table table-hover table-bordered">
                     <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
                        ...
                        <form action="" method="post">
                                ...
                                <div class="col-xs-2" style="margin: 10px;">
                                    <input class="form-control mr-sm-2" type="text" name="buscarDni" placeholder="Buscar por dni">
                                </div>
            ...
            if (!empty($PaginaAnterior)) {
                ?> 
               <li class="page-item">
                    <a class="page-link" href="menu_cliente.php<?php echo $PaginaAnterior; ?>" aria-label="Previous">
...
//--------------------------Paginación-------------------------------------------------------
            ...
            if (!empty($PaginaSiguiente)) {
                ?> 
                <li class="page-item">
                  <a class="page-link" href="menu_cliente.php<?php echo $PaginaSiguiente; ?>" aria-label="Next">
